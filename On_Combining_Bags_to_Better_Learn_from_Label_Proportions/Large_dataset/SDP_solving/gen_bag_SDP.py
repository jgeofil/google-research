...
print(data_dir)
print()
with open(f"{str(data_dir)}/corr_matrices_C14_bucket", "rb") as file_to_read:
...
with open(f"{str(data_dir)}/mean_vecs_C14_bucket", "rb") as file_to_read:
...
with open(f"{str(data_dir)}/normalized_W_C14_bucket_cvxopt", "wb") as file_to_write:
